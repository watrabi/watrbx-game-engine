...
public class RobloxSettings {
    ...
    static String  forumUrl()                   { return "http://www.watrbx.wtf/Forum/default.aspx"; }
    static String  blogUrl()                    { return "http://blog.watrbx.wtf/"; }
    static String  helpUrl()                    { return "https://en.help.watrbx.wtf/hc/en-us"; }
    ...
    private static String   rbxAnalyticsUrl()                                       { return "http://ecsv2.watrbx.wtf/pe.png?t=mobile&lt=" +
