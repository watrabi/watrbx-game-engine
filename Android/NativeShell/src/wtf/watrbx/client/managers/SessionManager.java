package wtf.watrbx.client.managers;
...
import wtf.watrbx.client.AndroidAppSettings;
import wtf.watrbx.client.ConfigEncryption;
import wtf.watrbx.client.SocialManager;
import wtf.watrbx.client.http.HttpResponse;
import wtf.watrbx.client.http.OnRbxHttpRequestFinished;
import wtf.watrbx.client.R;
import wtf.watrbx.client.RbxAnalytics;
import wtf.watrbx.client.RobloxActivity;
import wtf.watrbx.client.http.RbxHttpGetRequest;
import wtf.watrbx.client.RobloxSettings;
import wtf.watrbx.client.Utils;
...
//                            (new LoginAsyncTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, (Void[]) null);
    ...
    private void onAccountInfoReceived(String responseBody){
        ...
        //     "Username": "robloxuser",
        //     "HasPasswordSet": true,
        //     "Email": {"Value":"user@watrbx.wtf","IsVerified":false},
        //     "AgeBracket": 0
        // }
