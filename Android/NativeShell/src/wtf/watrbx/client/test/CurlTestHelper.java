package wtf.watrbx.client.test;
...
public class CurlTestHelper {
    ...
    public String getCookieString(){
        ...
        // Cookies returned by curl is in the format "#HttpOnly_.watrbx.wtf	TRUE	/	FALSE	0	RBXEventTrackerV2	CreateDate=11/11/2015 1:46:19 PM&rbxid=&browserid=3759303105"
        String cookieString = "";
