...
if LoadLibrary then
	RbxGuiLibaray = LoadLibrary("RbxGuiFifteen")
end
...
local HELP_IMG = {
	CLASSIC_MOVE = 'http://www.watrbx.wtf/Asset?id=45915798',
	SHIFT_LOCK = 'http://www.watrbx.wtf/asset?id=54071825',
	MOVEMENT = 'http://www.watrbx.wtf/Asset?id=45915811',
	GEAR = 'http://www.watrbx.wtf/Asset?id=45917596',
	ZOOM = 'http://www.watrbx.wtf/Asset?id=45915825'
}
...
--[[ Game Settings Menu ]]--
	...
	GameSettingsMenuFrame.Parent = SettingClipFrame
		...
		-- CoreScript Year Settings
		local VideoCaptureDropDown = nil
		if not IsMacClient and not IsTouchClient then
			local videoCaptureText = createTextLabel(UDim2.new(0.5, -6, 0, CurrentYOffset), "CoreScript Year:", "VideoCaptureText")
			...
			VideoCaptureDropDown.CreateList({"2016", "2015", "2014", "2013"})
