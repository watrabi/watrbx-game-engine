...
game:GetService("Players").FriendRequestEvent:connect(function(fromPlayer,toPlayer,event)
	...
	if fromPlayer == localPlayer then
		if event == Enum.FriendRequestEvent.Accept then
			...
			"With " .. toPlayer.Name .. "!",
			"http://www.watrbx.wtf/thumbs/avatar.ashx?userId="..tostring(toPlayer.userId).."&x=48&y=48",
			5,
			function()
	...
	elseif toPlayer == localPlayer then
		if event == Enum.FriendRequestEvent.Issue then
			...
			game:GetService("GuiService"):SendNotification("Friend Request",
				...
				"http://www.watrbx.wtf/thumbs/avatar.ashx?userId="..tostring(fromPlayer.userId).."&x=48&y=48",
				8,
				function()
