...
local mouseLockLookScreenUrl = "http://www.watrbx.wtf/asset?id=54071825"
local classicLookScreenUrl = "http://www.watrbx.wtf/Asset?id=45915798"
...
local CSManager = require(screenGui.Modules.CSManager)
...
local function createHelpDialog(baseZIndex)
	...
	buttons[2].Function = function() 
		image.Image = "http://www.watrbx.wtf/Asset?id=45915811"
	end 
	buttons[3] = {}
	buttons[3].Text = "Gear"
	buttons[3].Function = function() 
		image.Image = "http://www.watrbx.wtf/Asset?id=45917596"
	end
	buttons[4] = {}
	buttons[4].Text = "Zoom"
	buttons[4].Function = function() 	
		image.Image = "http://www.watrbx.wtf/Asset?id=45915825"
	end 
...
local function createGameSettingsMenu(baseZIndex, shield)
	...
	if not macClient and not touchClient then
		local YearSelectorLabel = Instance.new("TextLabel")
		YearSelectorLabel.Name = "YearSelectorLabel"
		YearSelectorLabel.Text = "CoreScript Year"
		YearSelectorLabel.Font = Enum.Font.SourceSansBold
		YearSelectorLabel.FontSize = Enum.FontSize.Size18
		YearSelectorLabel.Position = UDim2.new(0,32,0,itemTop + 6)
		YearSelectorLabel.Size = UDim2.new(0,164,0,18)
		YearSelectorLabel.BackgroundTransparency = 1
		YearSelectorLabel.TextColor3 = Color3I(255,255,255)
		YearSelectorLabel.TextXAlignment = Enum.TextXAlignment.Left
		YearSelectorLabel.ZIndex = baseZIndex + 4
		YearSelectorLabel.Parent = gameSettingsMenuFrame

		local videoCaptureDropDown = nil
		YearSelectorDropDown, updateYear = RbxGui.CreateDropDownMenu({"2016", "2015", "2014", "2013"}, 
			function(text) 
					print(text)
		...
		YearSelectorDropDown.Name = "YearSelectorDropDown"
		...
		YearSelectorDropDown.Position = UDim2.new(0, 270, 0, itemTop)
...
if LoadLibrary then
  RbxGui = LoadLibrary("RbxGuiFourTeen")
  local baseZIndex = 4
