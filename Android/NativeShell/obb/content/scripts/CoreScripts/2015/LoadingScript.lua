...
local function countConnectors()
	local count = 0
	local children = game.Workspace:GetChildren()
...
renderSteppedConnection = Game:GetService("RunService").RenderStepped:connect(function()
	...
	instanceCount = countInstances() --guiService:GetInstanceCount()
	voxelCount = 0 --guiService:GetVoxelCount()
	brickCount = countBricks()
	connectorCount = countConnectors() --guiService:GetConnectorCount()
