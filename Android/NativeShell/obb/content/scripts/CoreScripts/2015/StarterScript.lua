...
if useTopBar then
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/Topbar", screenGui)
end
...
if useNewSettings then
	...
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/Settings", screenGui)
end
...
if touchEnabled then
	if not luaControlsSuccess or luaControlsFlagValue == false then
		scriptContext:AddCoreScriptLocal("CoreScripts/2015/TouchControls", screenGui)
	end
end
...
if useNewDialogLook then
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/MainBotChatScript2", screenGui)
else
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/MainBotChatScript", screenGui)
end

-- Developer Console Script
scriptContext:AddCoreScriptLocal("CoreScripts/2015/DeveloperConsole", screenGui)

-- In-game notifications script
scriptContext:AddCoreScriptLocal("CoreScripts/2015/NotificationScript2", screenGui)

-- Chat script
if useTopBar then
	spawn(function() require(RobloxGui.Modules.Chat) end)
else
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/ChatScript2", screenGui)
end
...
if isNewPurchaseScript then
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/PurchasePromptScript2", screenGui)
else
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/PurchasePromptScript", screenGui)
end
-- Health Script
if not useTopBar then
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/HealthScript", screenGui)
end
...
if playerListSuccess and playerListFlagValue == true then
	...
	elseif isNotSmallTouchDevice then
		--scriptContext:AddCoreScriptLocal("CoreScripts/2015/PlayerListScript2", screenGui)
	end
elseif isNotSmallTouchDevice then
	--scriptContext:AddCoreScriptLocal("CoreScripts/2015/PlayerListScript", screenGui)
end
...
if useTopBar and (luaVehicleHudSuccess and luaVehicleHudEnabled == true) then
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/VehicleHud", screenGui)
end
...
if gamepadSupportSuccess and gamepadSupportFlagValue then
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/GamepadMenu", screenGui)
end

if touchEnabled then -- touch devices don't use same control frame
	-- only used for touch device button generation
	scriptContext:AddCoreScriptLocal("CoreScripts/2015/ContextActionTouch", screenGui)
