...
local function Initialize()
	...
	local function createYearOptions()
		YearSettingEnum = GameSettings.YearSetting

		this.YearFrame, 
		this.YearLabel,
		this.YearSlider = utility:AddNewRow(this, "Year", "Selector", {"2016", "2015", "2014", "2013"}, 1)
		this.YearSlider.IndexChanged:connect(function(newIndex)

			newIndex = newIndex - 1 -- adjust the slider being really weird and count from 1+ instead of 0+

			wait(1)
			
			GameSettings.YearSetting = newIndex
			local MenuModule = require(RobloxGui.Modules.Settings.SettingsHub)
			MenuModule.ToggleVisibility() -- Am I allowed to do this?
			wait(0.5)
			CSManager.switchgui(newIndex)
