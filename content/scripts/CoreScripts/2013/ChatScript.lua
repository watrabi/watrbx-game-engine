	...
	self.SafeChatFrame = Gui.Create'Frame' 
						{
							...
							Gui.Create'ImageButton'
							{
								...
								BackgroundTransparency = 1.0;
								Image = 'http://www.watrbx.wtf/asset/?id=97080365';
							};
						}
...
-- For touch devices we create a button instead 
function Chat:CreateTouchLeaveButton()	
	self.ChatLeaveFrame = Gui.Create'Frame'
		{
			Name = 'LeaveTouchFrame';
			Size = UDim2.new(0, 128, 0, 32);
			Position = UDim2.new(0, 88, 0, 0);
			BackgroundTransparency = 1.0;
			Parent = self.Gui;
			...
			Gui.Create'ImageLabel'
			{
				...
				Position = UDim2.new(0, 0, 0, 0);
				BackgroundTransparency = 1.0;
				Image = 'http://www.watrbx.wtf/asset/?id=1227'
			};

		}
	self.TapToLeave = self.ChatLeaveFrame.LeaveLabel	
	self.TapToLeaveBG = self.ChatLeaveFrame.Background

	self.TapToLeave.MouseButton1Click:connect(function()
		ChatLeaveFrame:SetVerb("Exit")
	end)
end
