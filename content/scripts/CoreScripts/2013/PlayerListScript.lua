...
function getMembershipTypeIcon(membershipType,playerName)
	if ADMINS[string.lower(playerName)]~=nil then
		if ADMINS[string.lower(playerName)] == 1 then
			return "http://www.watrbx.wtf/asset/?id=99727663"
		else
...
local function getFriendStatusIcon(friendStatus)
	...
	elseif friendStatus == Enum.FriendStatus.Friend then
		return "http://www.watrbx.wtf/asset/?id=99749771"
	elseif friendStatus == Enum.FriendStatus.FriendRequestSent then
		return "http://www.watrbx.wtf/asset/?id=99776888"
	elseif friendStatus == Enum.FriendStatus.FriendRequestReceived then
		return "http://www.watrbx.wtf/asset/?id=99776838"
	else
...
function MakePopupButton(nparent,ntext,index,last)
	...
	if index==0 then
		tobj.Image = 'http://www.watrbx.wtf/asset/?id=97108784'
	elseif last then
		if index%2==1 then
			tobj.Image = 'http://www.watrbx.wtf/asset/?id='.. Images['LightPopupBottom']
		else
			tobj.Image = 'http://www.watrbx.wtf/asset/?id='.. Images['DarkPopupBottom']
		end
	else
		if index%2==1 then
			tobj.Image = 'http://www.watrbx.wtf/asset/?id=97112126'
		else
			tobj.Image = 'http://www.watrbx.wtf/asset/?id=97109338'
		end
	end
	return tobj
end
...
local HeaderFrame = Obj.Create"Frame"
{
	...
	Parent = MainFrame,
	MakeBackgroundGuiObj('http://www.watrbx.wtf/asset/?id=94692054'),
}
...
local BottomShiftFrame = Obj.Create"Frame"
{
	...
	local BottomFrame = Obj.Create"Frame"
	{
		...
		MakeBackgroundGuiObj('http://www.watrbx.wtf/asset/?id=94754966'),
	}
		...
		local ExtendTab = Obj.Create"ImageButton"
		{
			...
			Active = true,
			BackgroundTransparency = 1,
			Image = 'http://www.watrbx.wtf/asset/?id=94692731',
...
local MiddleBGTemplate = Obj.Create"Frame"
{
	...
	Position = UDim2.new(100,0,.07,0),
	Size = UDim2.new(.5, 0, .025, 0),--UDim2.new(1, 0, .03, 0),
	MakeBackgroundGuiObj('http://www.watrbx.wtf/asset/?id=94692025'),
...
local AbuseSettingsFrame = Obj.Create"Frame"
{
	...
	Active = true,
	BackgroundTransparency = 1,
	MakeBackgroundGuiObj('http://www.watrbx.wtf/asset/?id=96488767'), -- 96480351'),
	Obj.Create"TextLabel"
	{
		Name = "Title",
		Text = "Report Abuse",
...
local SubmitReportButton = Obj.Create"ImageButton"
{
	...
	AutoButtonColor = false,
	Image = 'http://www.watrbx.wtf/asset/?id=96502438', -- 96501119',
	Parent = AbuseSettingsFrame,
}
...
local CancelReportButton = Obj.Create"ImageButton"
{
	...
	Image = 'http://www.watrbx.wtf/asset/?id=96500683',
	Parent = AbuseSettingsFrame,
}
...
local CalmingAbuseBox = Obj.Create'Frame'
{
	...
	MakeBackgroundGuiObj('http://www.watrbx.wtf/asset/?id=96506233'),
	Obj.Create'TextLabel'
	{
		Name = 'Header',
	...
	Obj.Create'ImageButton'
	{
		...
		Size = UDim2.new(0,150,0,50),
		AutoButtonColor = true,
		Image = 'http://www.watrbx.wtf/asset/?id=96507959',
	}
}
...
function debugprint(str)
 ...
 -- Script objects
 ------------------------- 
local RbxGui = assert(LoadLibrary('RbxGuiThirteen'))
...
for _,i in pairs(Images) do
	Game:GetService("ContentProvider"):Preload("http://www.watrbx.wtf/asset/?id="..i)
end
...
function HighlightMyRank(player,BanPlayerButton,VisitorButton,MemberButton,AdminButton)
	BanPlayerButton.Image= 'http://www.watrbx.wtf/asset/?id='..Images['LightPopupMid']
	VisitorButton.Image= 'http://www.watrbx.wtf/asset/?id='..Images['DarkPopupMid']
	MemberButton.Image= 'http://www.watrbx.wtf/asset/?id='..Images['LightPopupMid']
	AdminButton.Image= 'http://www.watrbx.wtf/asset/?id='..Images['DarkPopupBottom']
	
	local rank=player.PersonalServerRank
	if rank <= PrivilegeLevel['Banned'] then
		BanPlayerButton.Image='http://www.watrbx.wtf/asset/?id='..Images['LightBluePopupMid']
	elseif rank <= PrivilegeLevel['Visitor'] then
		VisitorButton.Image='http://www.watrbx.wtf/asset/?id='..Images['DarkBluePopupMid']
	elseif rank <= PrivilegeLevel['Member'] then
		MemberButton.Image='http://www.watrbx.wtf/asset/?id='..Images['LightBluePopupMid']
	elseif rank <= PrivilegeLevel['Admin'] then
		AdminButton.Image= 'http://www.watrbx.wtf/asset/?id='..Images['DarkBluePopupBottom']
	end
end
...
function CloseAbuseDialog()
	...
	SubmitReportButton.Image = 'http://www.watrbx.wtf/asset/?id=96502438' -- 96501119',
...
function InitReportAbuse()
	...
	UpdateAbuseFunction = function(abuseText) 
		...
		if AbuseName and SelectedPlayer then
			...
			SubmitReportButton.Image = 'http://www.watrbx.wtf/asset/?id=96501119'
		end
	end
...
function UpdateMinimize()
	...
	if IsMinimized.Value then
		...
		ExtendTab.Image = 'http://www.watrbx.wtf/asset/?id=94692731'
	else
		...
		ExtendTab.Image = 'http://www.watrbx.wtf/asset/?id=94825585' 
	end
end
...
function UpdateMaximize()
	if IsMaximized.Value then
		...
		HeaderFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['LargeHeader']
		BottomFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['LargeBottom']
		for index, i in ipairs(MiddleFrameBackgrounds) do
			if (index%2) ~= 1 then
				i.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['LargeDark']
			else
				i.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['LargeLight']
			end
		end
		...
		HeaderFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['NormalHeader']
		BottomFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['NormalBottom']
		for index, i in ipairs(MiddleFrameBackgrounds) do
			if index%2 ~= 1 then
				i.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['midDark']
			else
				i.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['midLight']
			end
		end
		for index, i in ipairs(MiddleFrames) do
			if i:FindFirstChild('ClickListener') then
...
function AddMiddleBGFrame()
	...
	if (#MiddleFrameBackgrounds+1)%2 ~= 1 then
		if IsMaximized.Value then
			nBGFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['LargeDark']
		else
			nBGFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['midDark']
		end
	else
		if IsMaximized.Value then
			nBGFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['LargeLight']
		else
			nBGFrame.Background.Image = 'http://www.watrbx.wtf/asset/?id='..Images['midLight']
		end
	end
