...
local function waitForChild(instance, name)
	while not instance:FindFirstChild(name) do
		...
		print('(Loadout): Waiting for ...', instance, name)
	end
...
--game.LocalBackpack:SetOldSchoolBackpack(true)
...
local backpackManager = waitForChild(guiBackpack,"CoreScripts/2013/BackpackScripts/BackpackManager")
