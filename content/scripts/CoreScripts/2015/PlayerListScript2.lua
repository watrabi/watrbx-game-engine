...
if LoadLibrary then
	RbxGuiLibrary = LoadLibrary("RbxGuiThirteen")
end
...
local ADMINS = {	-- Admins with special icons
    ['7210880'] = 'http://www.watrbx.wtf/asset/?id=134032333', -- Jeditkacheff
    ['13268404'] = 'http://www.watrbx.wtf/asset/?id=113059239', -- Sorcus
    ['261'] = 'http://www.watrbx.wtf/asset/?id=105897927', -- shedlestky
    ['20396599'] = 'http://www.watrbx.wtf/asset/?id=161078086', -- Robloxsai
}
...
local function onFollowButtonPressed()
	...
	if result["success"] then
		sendNotification("You are", "now following "..LastSelectedPlayer.Name, FRIEND_IMAGE..followedUserId.."&x=512&y=512", 5, function() end)
...
if IsServerCoreScripts and RemoteEvent_OnNewFollower then
	RemoteEvent_OnNewFollower.OnClientEvent:connect(function(followerRbxPlayer)
		sendNotification("New Follower", followerRbxPlayer.Name.."is now following you!",
			FRIEND_IMAGE..followerRbxPlayer.userId.."&x=512&y=512", 5, function() end)
	end)
end
