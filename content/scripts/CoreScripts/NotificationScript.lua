...
function makeFriend(fromPlayer,toPlayer)
	...
	popup.PopupImage.Image = "http://www.watrbx.wtf/Thumbs/Avatar.ashx?userId="..tostring(fromPlayer.userId).."&x=512&y=512"
	...
	elseif toPlayer == localPlayer then
		if event == Enum.FriendRequestEvent.Issue then
			...
			game:GetService("GuiService"):SendNotification("Friend Request",
				...
				"http://www.watrbx.wtf/thumbs/avatar.ashx?userId="..tostring(fromPlayer.userId).."&x=512&y=5128",
				8,
				function()
