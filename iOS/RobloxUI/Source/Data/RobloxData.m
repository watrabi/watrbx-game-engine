...
//{"UserId":68465808,"Name":"iMightBeLying","UserEmail":"kmulherin@watrbx.wtf","IsEmailVerified":true,"AgeBracket":2,"UserAbove13":true}
...
+(RBXSponsoredEvent*) SponsoredEventWithJson:(NSDictionary *)json
{
    ...
    //  "LogoImageURL":"http://images.watrbx.wtf/99bc31cc7d069159abb1e3e959a19724",
    //  "PageType":"Sponsored",
...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^{
        _completionQueue = dispatch_queue_create("wtf.watrbx.network_completion_queue", DISPATCH_QUEUE_CONCURRENT);
    });
}
          ...
          completion:(void (^)(NSArray* users)) handler
{
        ...
        handleSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
    {
        ...
        //"UserSearchResults": [
        //                      {
        //                          "AvatarUri": "http://t2.watrbx.wtf/d7882cb26ca4a298b386c9a4b1cbb24c",
        //                          "AvatarFinal": true,
        //                          "UserId": 68465808,
        //                          "Name": "iMightBeLying",
...
{
    //example
    //http://www.watrbx.wtf/leaderboards/rank/json?targetType=0&distributorTargetId=65241&timeFilter=0&max=1&imgWidth=30&imgHeight=30&imgFormat=png
    //{
    //  "Rank": 144,
    //  "DisplayRank": "144",
    //  "FullRank": null,
    ...
    //  "ClanEmblemID": 0,
    //  "UserImageUri": "http://t6.watrbx.wtf/74dc9e800fde9bea6c4e512860283620",
    //  "UserImageFinal": true,
    //  "ClanImageUri": "",
                   ...
                   completion:(void(^)(NSArray* leaderboard))handler
{
    ...
    ///     "WasPointsTruncated": false,
    ///     "ClanEmblemID": 0,
    ///     "UserImageUri": "http://t7.watrbx.wtf/85136625f88cd07dd4e22b2b7d7a75b8",
    ///     "UserImageFinal": true,
    ///     "ClanImageUri": "",
    ///     "ClanImageFinal": false
    ///}
