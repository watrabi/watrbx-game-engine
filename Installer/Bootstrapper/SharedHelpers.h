...
#define FIREFOXREGKEY               "@nsroblox.watrbx.wtf/launcher"
#define FIREFOXREGKEY64             "@nsroblox.watrbx.wtf/launcher64"
...
// Version URL string names (setup.watrbx.wtf/XXX) - replace XXX with these values to get the most recent version
