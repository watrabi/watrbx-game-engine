...
#define PLUGIN_DESCRIPTION "<a href=\"http://www.watrbx.wtf/\">RobloxLauncherPlugin</a> plugin."

#define MIME_DESCRIPTION   "application/x-vnd-roblox-launcher:.launcher:info@watrbx.wtf"
...
//roblox identifiers
static const CFStringRef s_rbx_app_bundle_id         = CFSTR("wtf.watrbx.RobloxPlayer");
static const CFStringRef s_rbx_app_bootstrapper_bundle_id = CFSTR("wtf.watrbx.Roblox");
static const CFStringRef s_rbx_pref_file_id          = CFSTR("wtf.watrbx.Roblox");
...
static const CFStringRef s_rbx_studio_app_bundle_id  = CFSTR("wtf.watrbx.RobloxStudio");
...
static const char       *s_rbx_host_str              = "watrbx.wtf";
static const char		*s_rbx_host_test_str		 = "pizzaboxer.fun";
