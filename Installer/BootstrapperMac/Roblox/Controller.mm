...
static NSString * const sPreferenceFileID        = @"wtf.watrbx.Roblox";
...
static NSString * const sClientApplicationBI        =@"wtf.watrbx.RobloxStudio";
...
static NSString * const sClientApplicationBI        =@"wtf.watrbx.RobloxPlayer";
...
- (void) verifyVersion
{
	...
	NSString *urlString = @"http://blog.watrbx.wtf/2012/09/roblox-discontinuing-support-for-mac-os-x-10-5/";
