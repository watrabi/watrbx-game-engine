...
static const TCHAR* BootstrapperMutexName           = _T("www.watrbx.wtf/bootstrapperQTStudio");
static const TCHAR* StartRobloxStudioAppMutex       = _T("www.watrbx.wtf/startRobloxQTStudioApp");
static const TCHAR* FriendlyName                    = _T("ROBLOX Studio");
static const TCHAR* StartEvent                      = _T("www.watrbx.wtf/robloxQTStudioStartedEvent");
