...
const String kRobloxHost = "watrbx.wtf";
const String kRobloxTestSiteHost = "pizzaboxer.fun";

//const String kRobloxHost = "LocalHost";

const String kMIMEDescription  = "application/x-vnd-roblox-launcher:.launcher:info@watrbx.wtf";
const String kPluginDescriptionString = "<a href=\"http://www.watrbx.wtf/\">RobloxLauncherPlugin</a> plugin.";
