...
using G3D::clamp;
    ...
    const char* const kBaseUrl = "https://www.sitetest1.pizzaboxer.fun/";
    const std::string kApiUrl = "https://api.sitetest1.pizzaboxer.fun/";
#else
    const char* const kBaseUrl = "https://www.watrbx.wtf/";
    const std::string kApiUrl = "https://api.watrbx.wtf/";
#endif

//const char* const kBaseUrl = "https://www.sitetest3.pizzaboxer.fun/";
//const std::string kApiUrl = "https://api.sitetest3.pizzaboxer.fun/";

//const char* const kBaseUrl = "https://www.gametest5.pizzaboxer.fun/";
//const std::string kApiUrl  = "https://api.gametest5.pizzaboxer.fun/";

//const char* const kBaseUrl = "https://www.gametest2.pizzaboxer.fun/";
//const std::string kApiUrl = "https://api.gametest2.pizzaboxer.fun/";

//const char* const kBaseUrl = "https://www.sitetest2.pizzaboxer.fun/";
//const std::string kApiUrl = "https://api.sitetest2.pizzaboxer.fun/";
        ...
        [=](...)->void 
        {
            ...
            if(1)
            {
                ...
                try
                {
                    ...
                    Http h(url);
                    h.additionalHeaders[Http::kRBXAuthenticationNegotiation] = "watrbx.wtf";
                    h.get(response);
