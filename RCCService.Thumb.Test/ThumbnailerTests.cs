...
//        }
        ...
        public IEnumerator<ITask> RunScriptAsync(ScriptExecution script, int key)
        {
            try
            {
                ...
                try
                {
                    ...
                    watrbx.wtfmon.AsyncHelper.Call(service.BeginBatchJobEx, job, script, service.EndBatchJobEx, result, timeout, service.Dispose );
                }
                catch (Exception)
                {
        ...
        {
            using (LuaScripts.pushBaseUrl("http://www.gametest1.pizzaboxer.fun/"))
            {
        ...
        public void TestShirtThumbOnGT1()
        {
            using (LuaScripts.pushBaseUrl("http://www.gametest1.pizzaboxer.fun/"))
            {
                RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.ShirtScript,
                    "http://www.gametest1.pizzaboxer.fun/asset/?id=81522820",
                    "PNG",
                    1024, 1024,
                    LuaScripts.getBaseUrl(),
                    "http://www.watrbx.wtf/asset/?id=242902171"));  //Roblox'S avatar
        ...
        {
            {
                RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.AvatarThumbScript,
                    "http://www.watrbx.wtf/Asset/AvatarAccoutrements.ashx?userId=1127502",
                    LuaScripts.getBaseUrl(),
                    "PNG",
        ...
        {
            using (LuaScripts.pushBaseUrl("http://www.gametest1.watrbx.wtf/"))
            {
                RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.BodyPartScript,
                    "http://www.gametest1.watrbx.wtf/Bear-Torso-item?id=25308616",
                    "http://www.gametest1.watrbx.wtf/",
                    "PNG",
                    1024, 1024,
                    "http://www.gametest1.watrbx.wtf/Asset/?id=1785197"));
            }
        }
        [TestMethod]
        public void TestRobloxAvatarThumbOnGT1()
        {
            ...
            {
                RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.AvatarThumbScript,
                    "http://www.gametest1.pizzaboxer.fun/Asset/AvatarAccoutrements.ashx?userId=1",
                    LuaScripts.getBaseUrl(),
                    "PNG",
                    1024, 1024,
                    "http://www.watrbx.wtf/Asset/AvatarAccoutrements.ashx?userId=504316"));  //Roblox'S avatar
            }
        }
        ...
        public void TestTorsoThumb()
        {
            {
                RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.BodyPartScript,
                    "http://www.watrbx.wtf/Bear-Torso-item?id=25004305",
                    "http://www.watrbx.wtf/",
                    "PNG",
                    1024, 1024,
                    "http://www.watrbx.wtf/Asset/?id=1785197"));  //RENDERMAN'S avatar
            }
        }
        ...
        {
            RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.AvatarThumbScript,
                "http://www.watrbx.wtf/Asset/AvatarAccoutrements.ashx?userId=504316",
                    LuaScripts.getBaseUrl(),
                    "PNG",
                    1024, 1024));  
        }
        ...
        {
            RunScript(LuaScripts.MakeCustomThumbScript(LuaScripts.AvatarThumbScript,
                "http://www.watrbx.wtf/Asset/AvatarAccoutrements.ashx?userId=4052914",
                    LuaScripts.getBaseUrl(),
                    "PNG",
                    1024, 1024));
        }
