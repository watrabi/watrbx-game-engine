...
public:
	ChatTester()
	{
...

        {
            ...
            //serverDm.execute("game:GetService('ContentProvider'):SetBaseUrl('http://www.gametest1.pizzaboxer.fun')", args);
            serverDm.execute("game.Players:SetChatFilterUrl('http://www.gametest1.pizzaboxer.fun/Game/ChatFilter.ashx')", args, RBX::Security::WebService);
	...
	{
		{
            ...
            RBX::Reflection::Tuple args;
			serverDm.execute("game:GetService('ContentProvider'):SetBaseUrl('http://www.watrbx.wtf')", args);
