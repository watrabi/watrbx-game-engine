...
public:
    ...
    {
        const ProtectedString serverScript = ProtectedString::fromTrustedSource("loadfile('http://www.watrbx.wtf/game/gameserver.ashx')(0, 53640)\n");
    ...
    {
        std::string response;
        Http("http://www.watrbx.wtf/game/join.ashx?UserID=0&serverPort=53640").get(response);
