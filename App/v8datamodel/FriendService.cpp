	...
	:enable(false)
{
	...
	//setMakeFriendUrl("http://siteapp3.watrbx.wtf/Friend/CreateFriend?firstUserId=%d&secondUserId=%d");
	//setGetFriendsUrl("http://siteapp3.watrbx.wtf/Friend/AreFriends?userId=%d");
	//setBreakFriendUrl("http://siteapp3.watrbx.wtf/Friend/BreakFriend?firstUserId=%d&secondUserId=%d");
}
