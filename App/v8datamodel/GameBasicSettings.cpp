...
static const Reflection::EnumPropDescriptor<GameBasicSettings, GameBasicSettings::YearSettings> prop_yearSetting("YearSetting", category_Appearance, &GameBasicSettings::getCurrentYear, &GameBasicSettings::setYear);
...
namespace RBX {
	namespace Reflection {
		...
		template <>
		EnumDesc<GameBasicSettings::YearSettings>::EnumDesc()
			:EnumDescriptor("yearSettings")
		{
			addPair(GameBasicSettings::Year2016, "2016");
			addPair(GameBasicSettings::Year2015, "2015");
			addPair(GameBasicSettings::Year2014, "2014");
			addPair(GameBasicSettings::Year2013, "2013");
		}
...
void GameBasicSettings::setYear(YearSettings setting)
{
	if (currentYear != setting)
	{
		currentYear = setting;
		raisePropertyChanged(prop_yearSetting);
	}
}
