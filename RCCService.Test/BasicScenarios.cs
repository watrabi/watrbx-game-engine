...
namespace RCCService.Test
{
    ...
    public class BasicScenarios
    {
        ...
        {
            using (LuaScripts.pushBaseUrl("http://gametest.watrbx.wtf/"))
            {
        ...
        public void TestLoadModel()
        {
            using (RCCServiceSoap service = Roblox.Grid.Common.GridServiceUtils.GetService(serviceUri.Host, serviceUri.Port))
            {
                ...
                try
                {
                    ...
                    LuaValue[] result = service.Execute(job.id, Lua.NewScript("LoadUnload", LuaScripts.LoadUnload, "http://www.watrbx.wtf/asset/?id=4446382"));
